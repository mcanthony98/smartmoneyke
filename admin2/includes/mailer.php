...
function maillinge($recipient, $subject, $body){
  ...
  //$signature = '<p><span style="color:#09479B;font-size:20px"> - Website Form</span></p>';
  ...
  $mailer->send($message);*/
     ...
     //Set parameters:
     $senderEmail = "noreply@sierrarestaurants.com"; //Sender's email, E.g. sender@gmail.com
     $senderPass = "Sierra@2024"; //Password of sender email account
     $recipient = $recipient; // Email of recipient. Where email is sent to.
     $subject = $subject; //Subject of the email
     $message = $body; //Email body/the message
     ...
     try {
         ...
         $mail->setFrom($senderEmail, 'Sierra Restaurants');
         
         //Recipients
         $mail->addAddress($recipient);              
         $mail->addReplyTo($senderEmail, 'Sierra Restaurants');
