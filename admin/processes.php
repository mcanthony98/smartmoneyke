...
if(isset($_POST["login"])){
    $_SESSION['chid'] = "1";
    $_SESSION['chname'] = "Money Smart Ke. Admin";
...
elseif(isset($_POST["edit-blog"])){
    ...
    $updqry = "UPDATE blog SET blog_title='$tit', blog_slag='$slag', blog_description='$desc', blog_content='$content', category_id='$cat', tags='$tags', blog_status='$status' WHERE blog_id  = '$id'";
